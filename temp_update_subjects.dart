...
Future<void> updateAllSubjects() async {
  ...
  try {
    ...
    final referenceSubjects = _getAllStageSubjectsFromCode();
...
List<Map<String, dynamic>> _getAllStageSubjectsFromCode() {
  return [
    ...
    // إضافة مواد المرحلة الإعدادية من JSON
    {
      'id': 'sec_4_islamic_sci',
      'name': 'التربية الإسلامية',
      'emoji': '☪️',
      'stage': 'إعدادية',
      'grade': 'الرابع',
